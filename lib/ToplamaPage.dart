...
class ToplamaPage extends StatefulWidget {
  @override
  _ToplamaPageState createState() => _ToplamaPageState();
}
...
class _ToplamaPageState extends State<ToplamaPage> {
  ...
  void rastgeleSayiGetir() {
    setState(() {
      sayi1 = Random().nextInt(49) + 1;
      sayi2 = Random().nextInt(49) + 1;
      toplam = sayi1 + sayi2;
      kontrolMesaji = '';
      denemeHakki = 3;
      sonucGirildi = false;
  ...
  void sonucuKontrolEt() {
    ...
    setState(() {
      if (girilenSonuc == toplam) {
        ...
        denemeHakki--;
        if (denemeHakki == 0) {
          kontrolMesaji = 'Deneme hakkınız kalmadı! Doğru sonuç: $toplam';
          skor -= 2;
          sonucController.text =
          '';
